...
a persistence unit "Proyecto-PlataformasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Proyecto-Plataformas/pom.xml":
...
artifact ("Proyecto-Plataformas.war") is already built. You can build
